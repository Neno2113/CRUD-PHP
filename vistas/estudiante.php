...
<body>
    <div class="container">
        <div class="row">
            <div class="col">
                <h3>Mantenimiento estudiantes</h3><hr>
                <a data-toggle="modal" href="#myModal"><button class="btn btn-success">Agregar Estudiante <i class="fa fa-user"></i></button></a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="titulo">Agregar Estudiantes</h4>
                        </div>
                        <div class="modal-body">
                            <form action="" id="formulario" name="formulario" method="POST">
                               ...
                               <div class="col-lg-6 col-md-6">
                                ...
                                <div class="form-group col-lg-6 col-md-6">
                                    <label>Curso(*):</label>
                                    <select name="idcurso" id="idcurso" class="form-control selectpicker" data-live-search="true" required>
